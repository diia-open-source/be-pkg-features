...
```
git clone https://github.com/diia-open-source/be-pkg-features.git pkg-features
```
...
In order to install and use the linked dependencies for `pkg-features` the following command can be used:

```
$ cd ./pkg-features
$ npm link @diia-inhouse/features @diia-inhouse/redis ... @diia-inhouse/<package-name>
```
